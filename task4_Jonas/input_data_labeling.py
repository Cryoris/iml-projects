...
def read_data_sets(train_dir, n_labeled = 100, fake_data=False, one_hot=False):
  ...
  TRAIN_IMAGES = "train_withoutLabel_useTrain.csv"#"train_labeled_withoutLabel_useTrain.csv"
  TRAIN_LABELS = "train_alllabels.csv"#"train_labeled_justLabel_useTrain.csv"
  TEST_IMAGES = "train_labeled_withoutLabel_useTest.csv"
  TEST_LABELS = "train_labeled_justLabel_useTest.csv"
  EVAL_IMAGES = "test.csv"#"train_unlabeled.csv"#"test.csv"
  VALIDATION_SIZE = 0
  ...
  # maybe .eval did something weird?
  data_sets.evalu = DataSet(eval_images, numpy.ones((eval_images.shape[0],10)))
