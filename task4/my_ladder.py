...
#%%
print("===  Loading Data ===")
mnist = my_input_data.read_data_sets("data/", n_labeled=num_labeled, one_hot=True)
...
pred_DF.to_csv("pred"+str(check_path[-2:])+str(layer_sizes).strip()+".csv", index_label=["Id"])
#%%
sess.close()
